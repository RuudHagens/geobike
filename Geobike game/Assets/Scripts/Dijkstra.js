...
//                throw "Node must be an array and contain 2 values (name, vertices).";
//            }
...
//                    throw "Vertex must be an array and contain 2 values (name, vertices).";
//                }
...
//        if (source === target) {
//            //return [];
//            throw "Source and target cannot be equal!";
//        }

//        // Reset all previous values
//        this.queue = new Dijkstras.MinHeap();
...
//            if (this.queue.getDistance(u) == Mathf.Infinity) {
//                return [];
//            }
...
//                var aDistance = uDistance + this.graph[u][neighbour];
...
//    Dijkstras.prototype.getPathLength = function(path) {
//        if (path.length <= 1) {
//            throw "Path must contain more than 1 node";
//        }
...
//            totalLength += this.graph[start][next];
//        }
...
//            // Consolidate
//            var depths = [[], [], [], [], [], [], []];
//            var maxDepth = depths.length - 1; // 0-index
//            var removeFromRoots = [];
...
//            for (var i = 0; i < length; i++) {
//                var node = this.roots[i];
//                var depth = this.nodes[node].depth;
...
//                while (depths[d].length > 1) {

//                    var first = depths[d].shift();
//                    var second = depths[d].shift();
//                    var newDepth = d + 1;
//                    var pos = -1;
